...
function ImageFlow ()
{
		...
		for (var index = 0; index < my.max; index++)
		{
			...
			if(my.imageScaling)
			{
				...
				else
				{
					...
					{	
						if(window.imageflow_addvar_saveimgsize) {
							image.style.height = Number(newImageH * 1.82) + 'px';
							image.style.width = Number(newImageW * 1.82) + 'px';
						} else {
	...
	this.glideTo = function(imageID)
	{
		...
		// hack
		my.onImageGlide(imageID, my.imagesDiv.childNodes[imageID], caption);
		// hack
	...
	this.Helper =
	{
		...
		removeEvent: function( obj, type, fn )
		{
			...
			else if (obj.detachEvent)
			{
				...
				{
					alert('Helper.removeEvent В» Pointer to detach event is undefined - perhaps you are trying to detach an unattached event?');
				}
